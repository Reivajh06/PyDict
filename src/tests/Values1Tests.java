...
/**
 * The class Values1Tests contains some tests to check the PyDict method
 * public Object[] values()
 */
public class Values1Tests{
    ...
    public void EmptyDictKeys(){
        assertEquals("[]", Arrays.toString(dict.values()));
    }
    ...
    public void NotEmptyDictKeys(){
        ...
        assertEquals("[1, 2, 3]", Arrays.toString(dict.values()));
    }
}